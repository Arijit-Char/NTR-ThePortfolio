            ...
            <div className="dizme_tm_portfolio">
                <div className="container">
                    ...
                    <div className="portfolio_filter">
                        <ul>
                            <li>
                                <a className={`c-pointer ${activeBtn('*')}`} onClick={handleTechStackFilterChange('*')}>
                                    All
                                </a>
                            </li>
                            {data &&
                                techStack?.map((data, i) => {
                                    return (
                                        <li key={i}>
                                            <a className={`c-pointer ${activeBtn(data)}`} onClick={handleTechStackFilterChange(data)}>
                                                {data}
                                            </a>
                                        </li>
                                    );
                            ...
                            {data &&
                                data?.map((data, i) => {
                                    return (
                                        <li
                                            key={i}
                                            className={`${data?.techStack} grid-item`}
                                            onClick={() => {
                                                setPopup(true);
                                                setPopupData(data);
                                            }}
